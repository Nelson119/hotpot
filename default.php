...
<head>
    ...
    <script src="scripts/cImg.js"></script>
    <script src="scripts/cScroll.js"></script>
    <script src="scripts/jquery.mousewheel.js"></script>
    <script src="scripts/cFB.js"></script>
    <script src="scripts/kRoot.js"></script>
    ...
    <div id="loading_page" style="display: none">
        <div class="loading_box">
            <div style="position: absolute; top: 236px; left: 66px; z-index: 99;">
                <img src="images/loading_txt.gif" width="108" height="31" />
            </div>
            ...
            <div class="circle_box">
                <div class="circle">
                    <div class="circle_bg">
                        <img src="images/loading_bg.jpg" style="margin-top: -14px;">
                    </div>
                </div>
                <div class="circle_hidden">
                    <img src="images/loading_hide.png" width="238" height="238" />
                </div>
                <div class="car">
                    <img src="images/loading_car.png" />
                    <div class="Wheel1">
            ...
            <div class="light_box_wrap">
                <div id="winners_bg">
                    ...
                    <div class="winners_title">
                        <img src="images/winners_title.png" />
                    </div>
                    <div class="w_box">
                        <div class="w1">
                            <div class="w1_title">
                                <img src="images/winners_t1.png" />
                            </div>
                            <div class="w1_box">
                                <div class="w1_p">
                                    <img src="images/winners_p1.png" />
                                </div>
                                <div style="position: absolute; width: 446px; top: 60px; left: 186px;">
                                    <img src="images/winners_txt1.png" />
                                </div>
                            </div>
                        </div>
                        <div class="w1">
                            <div class="w1_title">
                                <img src="images/winners_t2.png" />
                            </div>
                            <div class="w1_box">
                                <div class="w1_p">
                                    <img src="images/winners_p1.png" />
                                ...
                                <div style="position: absolute; width: 446px; top: 60px; left: 186px;">
                                    <img src="images/winners_txt2.png" />
                                </div>
                            </div>
                            <div class="w1_box">
                                <div class="w1_p">
                                    <img src="images/winners_p2.png" />
                                </div>
                                <div style="position: absolute; width: 446px; top: 33px; left: 186px;">
                                    <img src="images/winners_txt3.png" />
                                </div>
                            </div>
                            <div class="w1_box">
                                <div class="w1_p">
                                    <img src="images/winners_p3.png" />
                                </div>
                                <div style="position: absolute; width: 446px; top: 50px; left: 186px;">
                                    <img src="images/winners_txt4.png" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div id="big_photo_bg">
                    ...
                    <div id="big_photo">
                        <div id="show_loading" class="big_photo_loading">
                            <img src="images/89_2.GIF" width="64" height="64" />
                        </div>
                    </div>
            ...
            <div class="light_box_wrap">
                <div id="upload_bg">
                    ...
                    <div class="upload_bg">
                        ...
                        <div id="upload_photo">
                            <img src="images/upload_photo.gif" />
                        </div>
                        <div id="upload_photo_loading_box">
                            <div class="big_photo_loading">
                                <img src="images/89_3.GIF" width="64" height="64" />
                            </div>
                        </div>
                    </div>
        ...
        <div id="index_wrap">
            <div id="index_top">
                ...
                <div class="indxt_title_smoke">
                    <img src="images/index_title_smoke.png" />
                </div>
                ...
                <div class="index_photo">
                    <img src="images/index_asdf.png" />
                </div>
                <div class="index_pot">
                    <img src="images/index_pot.png" />
                </div>
                <div class="index_txt">
                    <img src="images/index_txt.png" />
                </div>
                <!--�ʺA�������ĪG-->
                <div id="index_smoke">
                    <img src="images/index_smoke.png" />
                </div>
                <!--���s�n���ʺA �s�����PNG-->
                <a id="cta" href="#">
                    <img src="images/cta.png" /></a>
            </div>
            <div id="index_bottom">
                <div class="photowall_txt_box">
                    <div class="photowall_txt">
                        <img src="images/photowall_txt.png" />
                    </div>
                    <div class="photowall_food">
                        <img src="images/laurel_food.png" />
                    </div>
                </div>
                    ...
                    <!--<div class="photowall_box">
                        <div class="photowall">
                            <div class="photo_hide">
                                <div class="photo">
                                    <img src="images/photo_238x238.png" />
                                </div>
                            </div>
                            ...
                            <a class="fb_share" href="#">
                                <img src="images/photo_fb_share.png" /></a>
    ...
    <div id="footer_wrap">
        <div id="footer">
            <div class="footer_txt1">
                <img src="images/footer_txt1.png" />
            </div>
            <a class="footer_txt2" href="#">
                <img src="images/footer_txt2.png" /></a>
        </div>
    </div>
